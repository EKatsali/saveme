...
Οι προγραμματιστές: Η ομάδα αυτή θα προγραμματίσει το edison ρομπότ. (Όλες οι ομάδες θα συνεργάζονται μεταξύ τους και δουλεύουν διεπιστημονικά για τη συνοχή της ομάδας)
