...
Οι κατασκευαστές: Η ομάδα αυτή των μαθητών αυτή θα κατασκευάσει τη μακέτα.  

Οι προγραμματιστές: Η ομάδα αυτή των μαθητών θα προγραμματίσει το edison ρομπότ. (Όλες οι ομάδες θα συνεργάζονται μεταξύ τους και δουλεύουν διεπιστημονικά για τη συνοχή της ομάδας)
